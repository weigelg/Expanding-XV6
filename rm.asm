...
main(int argc, char *argv[])
{
  ...
  4d:	50                   	push   %eax
  4e:	e8 4f 04 00 00       	call   4a2 <unlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5a5:	0f b6 80 90 0c 00 00 	movzbl 0xc90(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 6e1:	75 25                	jne    708 <printf+0xff>
          s = "(null)";
 6e3:	c7 45 f4 fc 09 00 00 	movl   $0x9fc,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7a9:	a1 ac 0c 00 00       	mov    0xcac,%eax
...
free(void *ap)
{
 ...
 874:	a3 ac 0c 00 00       	mov    %eax,0xcac
}
 879:	90                   	nop
 87a:	c9                   	leave  
 87b:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8d2:	83 c4 10             	add    $0x10,%esp
  return freep;
 8d5:	a1 ac 0c 00 00       	mov    0xcac,%eax
}
 8da:	c9                   	leave  
 8db:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8ee:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8f1:	a1 ac 0c 00 00       	mov    0xcac,%eax
 8f6:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8f9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8fd:	75 23                	jne    922 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8ff:	c7 45 f0 a4 0c 00 00 	movl   $0xca4,-0x10(%ebp)
 906:	8b 45 f0             	mov    -0x10(%ebp),%eax
 909:	a3 ac 0c 00 00       	mov    %eax,0xcac
 90e:	a1 ac 0c 00 00       	mov    0xcac,%eax
 913:	a3 a4 0c 00 00       	mov    %eax,0xca4
    base.s.size = 0;
 918:	c7 05 a8 0c 00 00 00 	movl   $0x0,0xca8
 91f:	00 00 00 
  }
 ...
 975:	a3 ac 0c 00 00       	mov    %eax,0xcac
      return (void*)(p + 1);
 ...
 980:	eb 3b                	jmp    9bd <malloc+0xe1>
    ...
    if(p == freep)
 982:	a1 ac 0c 00 00       	mov    0xcac,%eax
